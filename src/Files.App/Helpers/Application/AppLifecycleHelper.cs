...
namespace Files.App.Helpers
{
	...
	{
		private readonly static string AppInformationKey = @$"Software\Files Community\{AppData.PackageName}\v1\AppInformation";
		...
		public static Version AppVersion { get; } =
			new(AppData.Version.Major, AppData.Version.Minor, AppData.Version.Build, AppData.Version.Revision);

		/// <summary>
		/// Gets application icon path.
		/// </summary>
		public static string AppIconPath { get; } =
			SystemIO.Path.Combine(AppData.InstalledLocationPath, AppEnvironment switch
			{
		...
		public static void ConfigureSentry()
		{
			SentrySdk.Init(options =>
			{
				...
				var packageVersion = AppData.Version;
				...
				options.CacheDirectoryPath = AppData.LocalFolderPath;
		...
		public static IServiceProvider ConfigureHost(AppModel appModel)
		{
			...
			var fileLoggerProvider = new FileLoggerProvider(Path.Combine(AppData.LocalFolderPath, "debug.log"));

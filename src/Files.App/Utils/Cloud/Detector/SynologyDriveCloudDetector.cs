...
namespace Files.App.Utils.Cloud
{
	...
	public sealed class SynologyDriveCloudDetector : AbstractCloudDetector
	{
		protected override async IAsyncEnumerable<ICloudProvider> GetProviders()
		{
			...
			await configFile.CopyAsync(await AppData.GetTemporaryFolderAsync(), "synology_drive.db", NameCollisionOption.ReplaceExisting);

			var syncDbPath = Path.Combine(AppData.TemporaryFolderPath, "synology_drive.db");

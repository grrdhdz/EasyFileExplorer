...
namespace Files.App.Utils.Shell
{
	...
	public static class ShellNewMenuHelper
	{
		...
		{
			var folder = await SafetyExtensions.IgnoreExceptions(async () => await (await AppData.GetLocalFolderAsync()).CreateFolderAsync("extensions", CreationCollisionOption.OpenIfExists));
